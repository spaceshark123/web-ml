          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <Select value={selectedDataset} onValueChange={(v: string) => setSelectedDataset(v)}>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v: string) => setSelectedModel1(Number.parseInt(v))}
                >
                  <SelectTrigger className="bg-white border-gray-300">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v: string) => setSelectedModel2(Number.parseInt(v))}
                >
                  <SelectTrigger className="bg-white border-gray-300">
